 ...
 * @param {string} options.liveCollection - Name of the live collection ('Contacts').
 * @param {string} options.archiveCollection - Name of the archive collection (e.g., 'archive_Contacts').
...
async function main() {
  ...
  const LIVE_COLLECTION = 'Contacts';
  const ARCHIVE_COLLECTION = 'archive_Contacts';
